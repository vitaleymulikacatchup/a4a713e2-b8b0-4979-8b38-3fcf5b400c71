...
export const metadata: Metadata = {
  title: "Medical Cannabis Dispensary | MediCare Cannabis",
  description: "Licensed medical cannabis dispensary offering lab-tested products and expert patient guidance for health and wellness support.",
  keywords: "medical cannabis, dispensary, CBD, THC, medical marijuana, patient care",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "MediCare Cannabis - Premium Medical Products",
    description: "Lab-tested medical cannabis for health-conscious patients seeking quality and professional guidance.",
    type: "website",
    siteName: "MediCare Cannabis",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SgGlSmvaVv2SYOkECykbr8Q49/uploaded-1764083086073-0ktmi50i.jpg",
        alt: "Medical cannabis products"
      }
    ]
  }
};
